...
public class WorkflowUtils {
	 ...
	 * @return Url
	 */
	public static String getUrlFromFormPropertiesById(List<FormProperty> formProperties, String id) {
	...
	public static WorkflowEntity getWorkflowEntity(String processInstanceId) {
		...
		if (historicProcessInstance != null) {
			...
			workflowEntity.setProcessDefinition(repositoryService.createProcessDefinitionQuery()
		...
		workflowEntity.setHistoricTaskInstances(historyService.createHistoricTaskInstanceQuery()
				.processInstanceId(processInstanceId).orderByHistoricTaskInstanceEndTime().asc().list());
		workflowEntity.setHistoricVariableInstances(
