...
<head>
	...
	<script type="text/javascript">
		var trId;
		$(document).ready(function() {var officeId = '${officeId}';
			if (officeId != "" && officeId != undefined) {
				$("#"+officeId).click();  
			//} else {
			//	window.parent.centerFrame.location.href='${ctx}/asmt/assementUser/groupMembersList';
			}
		});
		function page(n,s){
			$("#pageNo").val(n);
		...
		function checkGroupingValidity() { 
		    ...
		    $("#listForm").attr("action", "${ctx}/asmt/assementUser/checkGroupingValidity?officeId="+trId);
		    $("#listForm").submit();
    	}
	</script>
</head>
	...
	<form id="listForm" method="post" target="mainFrame">
		<table id="treeTable" class="table table-striped table-bordered table-condensed">
			<tr>
				...
				<th style="text-align:center; width: 70px;">成员单位数</th>
			</tr>
