...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules: {
					loginName: {remote: "${ctx}/asmt/unit/checkLoginName?oldLoginName=" + encodeURIComponent('${user.loginName}')}
				},
				messages: {
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/asmt/unit/">用户列表</a></li>
		<li class="active"><a href="${ctx}/asmt/unit/form?id=${user.id}">用户<shiro:hasPermission name="asmt:unit:edit">${not empty user.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="asmt:unit:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/asmt/unit/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
