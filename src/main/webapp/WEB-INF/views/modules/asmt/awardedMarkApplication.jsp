...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/asmt/assementUser/awardedMarkApplication">加分申请</a></li>
	...
	<form:form id="searchForm" modelAttribute="assementUser" action="${ctx}/asmt/assementUser/awardedMarkApplication" method="post" class="breadcrumb form-search">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
		<label>申请单位 ：</label><form:input path="userName" htmlEscape="false" maxlength="50" class="input-small"/>
	...
	<table id="treeTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list }" var="am">
			<tr>
