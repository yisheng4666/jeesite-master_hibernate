...
<head>
	...
	<script type="text/javascript">
		...
		function assignUser(type) {
			...
			window.top.$.jBox.open("iframe:${ctx}/asmt/rule/usertorule?id=${rule.id}&type="+type, type==1 ? "关联评分用户" : "关联事件录入用户", 460, 200, 
...
<body>
	...
	<form:form id="inputForm" modelAttribute="rule" action="${ctx}/asmt/rule/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="content" htmlEscape="false" rows="4" maxlength="500" class="required input-xxlarge"/>
			</div>
		</div>
		<div class="control-group">
