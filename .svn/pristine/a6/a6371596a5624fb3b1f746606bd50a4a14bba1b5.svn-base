...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/workflow/processList/">流程列表</a></li>
		<shiro:hasPermission name="sys:user:edit"><li><a href="${ctx}/sys/workflow/form">流程添加</a></li></shiro:hasPermission>
	</ul>
